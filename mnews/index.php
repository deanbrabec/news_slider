...
?&gt;</textarea>';
			...
			if ($conf['admin_url'] != $url_path) {
				echo '<div class="db-info round"><img src="./stuff/img/icons/information.png" alt="(i)" /> ' . str_ireplace('%config%', '<a href="./mn-config.php">' . $lang['config_config'] . '</a>', $lang['index_admin_url_check']) . '</div>';
			}
		...
		if ($auth == 1 && (!isset($_COOKIE['mn_db_widgets']) || $_COOKIE['mn_db_widgets'][4] == 1)) {
