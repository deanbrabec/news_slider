    ...
    <tbody>
      <?php
        foreach ($galleries as $gallery_id => $gallery_name) {
          ...
          echo '<tr><td class="c">' . $gallery_id . '</td><td><a href="./mn-galleries.php?action=edit&amp;id=' . $gallery_id . '" class="main-link">' . $gallery_name . '</a><br />&nbsp;<span class="links hide"><a href="./mn-galleries.php?action=edit&amp;id=' . $gallery_id . '">' . $lang['uni_edit'] . '</a> &middot; <a href="./mn-galleries.php?action=code&amp;gal=' . $gallery_id . '" class="fancy">' . $lang['uni_code'] . '</a> &middot; <a href="./mn-galleries.php?action=delete&amp;id=' . $gallery_id . '" class="fancy">' . $lang['uni_delete'] . '</a></span></td><td class="c">' . $gallery_files_count . '</td></tr>';
        }
      ?>
    </tbody>
  </table>
