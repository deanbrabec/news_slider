	 	...
	 	$(document).ready( function() {
			...
			<form action="./mn-files.php" method="post" enctype="multipart/form-data" id="uploadify-form">
				...
				<div class="cleaner">&nbsp;</div>
		 		<div class="simbutton hide" id="upload-btn"><a href="javascript:$('#multiupload').uploadify('upload', '*')" style="margin: 0 auto;"><img src="./stuff/img/icons/folder-go.png" alt="" width="16" height="16" /> <?php echo $lang['files_upload_files'];?></a></div>
			</form>
...
?>
	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$('#mn-popup form').on('submit', function() {
...
?>	
	...
	<form action="./mn-files.php" method="post" enctype="multipart/form-data" id="uploadify-form">
		...
		<div class="cleaner">&nbsp;</div>
		<div class="c">
 		<div class="simbutton hide" id="upload-btn"><a href="javascript:$('#multiupload').uploadify('upload', '*')" style="margin: 0 auto;"><img src="./stuff/img/icons/folder-go.png" alt="" width="16" height="16" /> <?php echo $lang['files_upload_files'];?></a></div></div>
	</form>
...
?>
  ...
  <div class="rel-links">
    <a href="./mn-folders.php"><img src="./stuff/img/icons/folders.png" alt="" /> <?php echo $lang['folders_folders'];?></a> &middot;
    <a href="./mn-galleries.php"><img src="./stuff/img/icons/images.png" alt="" /> <?php echo $lang['galleries_galleries'];?></a> &middot;
