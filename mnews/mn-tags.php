    ...
    <tbody>
      <?php
        foreach ($tags as $tag_id => $tag_name) {
          ...
          echo '<tr><td class="c">' . $tag_id . '</td><td><a href="./mn-tags.php?action=edit&amp;id=' . $tag_id . '" class="main-link">' . $tag_name . '</a><br />&nbsp;<span class="links hide"><a href="./mn-tags.php?action=edit&amp;id=' . $tag_id . '">' . $lang['uni_edit'] . '</a> &middot; <a href="./mn-tags.php?action=delete&amp;id=' . $tag_id . '" class="fancy">' . $lang['uni_delete'] . '</a></span></td><td class="c">' . $tag_posts_count . '</td></tr>';
        }
      ?>
    </tbody>
  </table>
