...
?>
  ...
  <form action="./mn-users.php" method="post" id="users-add-edit">
    ...
    <?php if ($var['action'] == 'edit') { ?><p class="r"><span class="simurl toggle750" rel="admin-info"><img src="./stuff/img/icons/shield.png" alt="" /> <?php echo $lang['users_admin_info'];?></span> &middot; <span class="simurl" id="personal-info-toggle"><img src="./stuff/img/icons/user-personal-info.png" alt="" /> <?php echo $lang['users_personal_and_contact_info'];?></span></p><?php } ?>
