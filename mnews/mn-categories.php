      ...
      <?php
        if (!empty($categories)) {
          foreach ($categories_order as $cat_order => $cat_id) {
            ...
            echo '<tr id="' . $cat_id . '"><td class="c">' . $cat_id . '</td><td><a href="./mn-categories.php?action=edit&amp;id=' . $cat_id . '" class="main-link">' . $categories[$cat_id] . '</a><br />&nbsp;<span class="links hide"><a href="./mn-categories.php?action=edit&amp;id=' . $cat_id . '">' . $lang['uni_edit'] . '</a> &middot; <a href="./mn-categories.php?action=delete&amp;id=' . $cat_id . '" class="fancy">' . $lang['uni_delete'] . '</a></span></td><td class="c">' . $cat_posts_count . '</td><td class="dragHandle"></td></tr>';
